...
from benchsci.vendor_catalog.library_translation.views import UploadView, ListVendorFilesView, DownloadView, GenerateTranslationView
...
urlpatterns = [
    ...
    path("generate/", GenerateTranslationView.as_view()),
